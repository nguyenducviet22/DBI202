...
********************************************************************************/
IF EXISTS (SELECT name FROM master.dbo.sysdatabases WHERE name = N'PE1')
BEGIN
	ALTER DATABASE [PE1] SET OFFLINE WITH ROLLBACK IMMEDIATE;
	ALTER DATABASE [PE1] SET ONLINE;
	DROP DATABASE [PE1];
END
